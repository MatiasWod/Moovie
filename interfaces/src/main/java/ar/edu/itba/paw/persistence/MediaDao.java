...
public interface MediaDao {
    List<Media> getMedia(int type, String search, String participant, List<String> genres, List<Integer> providers, List<String> status, List<String> lang, String orderBy, String sortOrder, int size, int pageNumber, int currentUserId);
    ...
    int getMediaCount(int type, String search, String participant, List<String> genres, List<Integer> providers, List<String> status, List<String> lang);

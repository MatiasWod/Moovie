...
<div class="container my-1">
    <div class="row align-items-center justify-content-center">
        ...
        <div class="row ">
            ...
            <hr class="my-8">
            <div class="d-flex flex-row align-items-center">
                <c:forEach var="actor" begin="0" end="3" step="1" items="${actorsList}">
                        <div class="card" style="max-width: 300px;border-radius: 5px; margin: 5px">
                            <div class="row">
                                <div class="col-4">
                                    <img
                                            src="${actor.profilePath}"
                                            alt="${actor.actorName} picture" style="max-width: 150px; max-height: 150px; border-radius: 5px"></div>
                ...
                <c:if test="${fn:length(actorsList) > 4}">
                    <div class="p-2 align-items-bottom">
                        <button type="button" class="btn btn-dark" onclick="showMoreActors()">See more</button>
                    </div>
                </c:if>
            </div>
        </div>

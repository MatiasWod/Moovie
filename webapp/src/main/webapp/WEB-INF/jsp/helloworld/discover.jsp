...
<%--                 &lt;%&ndash;   ES NECESARIO UTILIZAR LA VAR isChecked.--%>
...
<%--                   Es preferible esto a en el controlador manejar la creacion de modelos nuevos que contemplen el checked para cada genero&ndash;%&gt;--%>
<%--                                <c:forEach var="genre" items="${genresList}">--%>
<%--&lt;%&ndash;                                    selectedGenre no deberia ser muy grande, ya que es el listado de genres seleccionados&ndash;%&gt;--%>
...
<%--&lt;%&ndash;                                        Por el uso de inner text en el beforeSubmit, la label debe estar en este formato. Para no captar espacios de la estructura del html. por mas que el estilo no sea el mejor--%>
<%--                                            sino hay que usar fn:trim para cada comparacion del isChecked, lo cual es un gran desperdicio de performance a cambio de un cambio de la estructura del html&ndash;%&gt;--%>
...
<%--                        </select>--%>
<%--                        &lt;%&ndash;                PARA TENER EN CUENTA --> MIRAR EL DEFAULT sort y orderBy en el controller para settear los valores iniciales de las labels/iconos&ndash;%&gt;--%>

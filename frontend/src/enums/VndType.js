export const VndType = {
  ...
  APPLICATION_ACTOR_LIST: 'application/vnd.actor-list.v1+json',

  // Tipo de medio para un actor individual
  APPLICATION_ACTOR: 'application/vnd.actor.v1+json',

  // Tipo de medio para un comentario individual
  APPLICATION_COMMENT: 'application/vnd.comment.v1+json',

  // Tipo de medio para crear un comentario individual
  APPLICATION_COMMENT_FORM: 'application/vnd.comment-form.v1+json',

  // Tipo de medio para crear un feedback de un comentario individual
  APPLICATION_COMMENT_FEEDBACK_FORM: 'application/vnd.comment-feedback-form.v1+json',

  // Tipo de medio para una lista de comentarios
  APPLICATION_COMMENT_LIST: 'application/vnd.comment-list.v1+json',

  // Tipo de medio para una lista de directores
  APPLICATION_DIRECTOR_LIST: 'application/vnd.director-list.v1+json',

  // Tipo de medio para un director individual
  APPLICATION_DIRECTOR: 'application/vnd.director.v1+json',

  // Tipo de medio para una lista de generos
  APPLICATION_GENRE_LIST: 'application/vnd.genre-list.v1+json',

  // Tipo de medio para una lista de medias
  APPLICATION_MEDIA_LIST: 'application/vnd.media-list.v1+json',
  ...
  APPLICATION_MOOVIELIST_LIST: 'application/vnd.moovielist-list.v1+json',

  // Tipo de medio para una lista de MoovieList
  APPLICATION_MOOVIELIST: 'application/vnd.moovielist.v1+json',
  ...
  APPLICATION_MOOVIELIST_MEDIA_LIST: 'application/vnd.moovielist-media-list.v1+json',

  // Tipo de medio para operaciones relacionadas con medios (Media) en una MoovieList
  APPLICATION_MOOVIELIST_MEDIA_FORM: 'application/vnd.moovielist-media-form.v1+json',

  // Tipo de medio para una reseña individual de MoovieList
  APPLICATION_MOOVIELIST_REVIEW: 'application/vnd.moovielist-review.v1+json',

  // Tipo de medio para una lista de reseñas de MoovieList
  APPLICATION_MOOVIELIST_REVIEW_LIST: 'application/vnd.moovielist-review-list.v1+json',
  ...
  APPLICATION_WATCHED_MEDIA: 'application/vnd.watched-media.v1+json',

  // Tipo de medio para operaciones de creación/edición de una media de Watched
  APPLICATION_WATCHED_MEDIA_FORM: 'application/vnd.watched-media-form.v1+json',

  // Tipo de medio para la lista de "Watchlist"
  APPLICATION_WATCHLIST_LIST: 'application/vnd.watchlist-list.v1+json',

  // Tipo de medio para un medio en la lista de "Watchlist"
  APPLICATION_WATCHLIST_MEDIA: 'application/vnd.watchlist-media.v1+json',

  // Tipo de medio para operaciones de creación/edición de una media de Watchlist
  APPLICATION_WATCHLIST_MEDIA_FORM: 'application/vnd.watchlist-media-form.v1+json',

  // Tipo de medio para la lista de listas seguidas (Follows)
  APPLICATION_FOLLOWED_LISTS: 'application/vnd.followed-lists.v1+json',
  ...
  APPLICATION_TVCREATOR: 'application/vnd.tvcreator.v1+json',
  ...
  APPLICATION_USER_TOKEN: 'application/vnd.user_token.v1+json',

...
export default function App() {
  ...
  const handleLocationChange = useCallback(
    (location) => {
      // Only refresh user data if initialized and user is actually logged in
      // This prevents unnecessary API calls and potential session clearing
    ...
    [dispatch, authInitialized, isLoggedIn]
  );
          ...
          <ContextProviderWrapper>
            <Routes>
              ...
              <Route
                path="/login"
                element={
                  <LoggedGate protectForLoggedIn={true}>
                    <Login />
                  </LoggedGate>
                }
              />
              ...
              <Route
                path="/reports"
                element={
                  <RoleGate role={UserRoles.MODERATOR}>
                    <ReportsDashboard />
                  </RoleGate>
                }
              />

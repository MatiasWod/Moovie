    ...
    <main className="moovie-default default-container">
      ...
      <div>
        <div className="container d-flex justify-content-between p-2 position-relative">
          ...
          <a onClick={handleTopRatedMoviesButtonClick} className="link-button">
            {t('home.seeMore')}
          </a>
          <Divider
            sx={{
      ...
      <div>
        <div className="container d-flex justify-content-between p-2 position-relative">
          ...
          <a onClick={handleMostPopularMoviesButtonClick} className="link-button">
            {t('home.seeMore')}
          </a>
          <Divider
            sx={{
      ...
      <div>
        <div className="container d-flex justify-content-between p-2 position-relative">
          ...
          <a onClick={handleTopRatedSeriesButtonClick} className="link-button">
            {t('home.seeMore')}
          </a>
          <Divider
            sx={{
      ...
      <div>
        <div className="container d-flex justify-content-between p-2 position-relative">
          ...
          <a onClick={handleMostPopularSeriesButtonClick} className="link-button">
            {t('home.seeMore')}
          </a>
          <Divider
            sx={{

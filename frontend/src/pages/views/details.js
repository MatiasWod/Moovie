...
function Details() {
  ...
  if (media.type === 'Movie') {
    ...
    info = (
      <h5>
        {releaseYear} • {media.runtime} m • {t('details.movie')}
      </h5>
    );
  } else {
    detailsColumn = (
      <span>
        ...
        {media.lastAirDate && (
          <div className="d-flex flex-row align-items-center">
            ...
            <MediaTag
              text={new Date(media.lastAirDate).toISOString().split('T')[0]} // Esto toma solo la parte YYYY-MM-DD
            />
          </div>
        )}
        ...
        {media.nextEpisodeToAir && (
          <div className="d-flex flex-row align-items-center ">
            ...
            <MediaTag
              text={new Date(media.nextEpisodeToAir).toISOString().split('T')[0]} // Esto toma solo la parte YYYY-MM-DD
            />
          </div>
        )}
      </span>
    ...
    info = (
      <h5>
        {releaseYear} • {t('details.serie')} • {media.numberOfSeasons} {t('details.seasons')} •{' '}
        {media.numberOfEpisodes} {t('details.episodes')}
      </h5>
    );
  }
  ...
  return (
    <div className="container my-1">
          ...
          <div>
            <h1 className="d-flex flex-row align-items-center ">
              <OverlayTrigger
                trigger={['hover', 'focus']}
                placement="right"
                overlay={popoverMoovieRating}
              >
                <div className="me-3">
                  <i className={'bi bi-star-fill'} /> {media.tmdbRating}
                </div>
              </OverlayTrigger>
      ...
      <div className="row">
        ...
        <Reviews
          key={reloadReviews ? id : undefined}
          id={id}

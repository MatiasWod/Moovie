              ...
              <div className="p-6">
                <div className="flex items-start gap-4 mb-4">
                  ...
                  <div className="flex-1">
                    <a className="text-lg font-bold text-gray-800 mb-1" href={process.env.PUBLIC_URL + `/profile/${user.username}`}>{user.username}</a>
                ...
                <div className="bg-gradient-to-r from-red-50 to-red-100 rounded-lg p-4 mb-4 border-l-4 border-red-300">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-sm font-medium text-red-600">{t('reports.content.banReason')}</span>
                  </div>
                  <p className="text-red-800 text-sm leading-relaxed">{user.banMessage.banMessage}</p>
                </div>

    ...
    return (
      <div className="overlay">
        <div
          ...
          style={{ textAlign: 'center', width: '70%', padding: '3em', margin: '2em auto' }}
        >
          <h2 style={{ marginBottom: '1.5em' }}>
            {t('confirmationForm.prompt', { actionName: actionName })}
          </h2>
          <div
            className="buttons"
            style={{ display: 'flex', justifyContent: 'center', gap: '1.5em' }}
          >

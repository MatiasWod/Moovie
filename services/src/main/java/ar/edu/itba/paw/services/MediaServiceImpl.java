...
public class MediaServiceImpl implements MediaService{
    ...
    @Override
    public List<Media> getMedia(int type, String search, List<String> genres, String orderBy, int size, int pagNumber) {
        return mediaDao.getMedia(type, search, genres, orderBy, size, pagNumber);
    }
